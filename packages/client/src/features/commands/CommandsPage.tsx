    ...
    return (
      <div>
        ...
        <EmptyState
          ...
          description="Commands are the BMAD slash commands available in your IDE — things like /create-prd, /sprint-planning, or /code-review. They're populated from the bmad-help.csv file generated by your installed modules. Install a module to populate this list."
          actions={
            <Link
              to="/modules"
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {ides.map((ide) => (
                <span key={ide} className="flex items-center gap-1.5 text-xs">
                  ...
                  <span className="w-2 h-2 rounded-full bg-[var(--color-success)]" title="Commands synced" />
                </span>
              ))}
            </div>
            <Link
        ...
        <div className="mb-6 flex items-start gap-3 rounded-lg border border-[var(--color-warning)]/30 bg-[var(--color-warning)]/5 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[var(--color-muted)] mt-0.5">
              Configure an IDE connection so these commands are available as slash commands in your editor.
            </p>
          </div>
          <Link
            to="/connections"
